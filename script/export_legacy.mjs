...
const models=["Course", "Review", "ReviewLike", "ReviewDislike", "ReviewComment", "ReviewCommentReaction", "ReviewCommentReport", "ReviewReport", "CourseBookmark", "Mentor", "MentorReview", "MentorReviewLike", "MentorReviewDislike", "MentorReviewComment", "MentorReviewCommentReaction", "MentorReviewCommentReport", "MentorReviewReport"];
const payload={format:'riverside-community-v1',project:'course-review',exported_at:new Date().toISOString(),tables:{},media:[]};
try {
